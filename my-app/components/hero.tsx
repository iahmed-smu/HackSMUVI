      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">SMU Health and Wellness</h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">A comprehensive platform for SMU students to receive various medical services. Featuring a fitness tracking calendar, mental health resources, teletherapy, and peer to peer online counseling.</p>
          </div>
